...
class Ui_Eyelinkplotter(object):
    def setupUi(self, Eyelinkplotter):
        ...
        self.gridLayoutWidget_9.setGeometry(QtCore.QRect(39, 109, 351, 51))
        ...
        self.AnimationLayout.addWidget(self.frameStepSizeL, 0, 0, 1, 1)
